...
```bash
curl -s https://raw.githubusercontent.com/leoguiders/FireMotD/master/FireMotD -o /tmp/FireMotD && chmod 755 /tmp/FireMotD && sudo /tmp/FireMotD -I -d && /tmp/FireMotD -G all -d
```
